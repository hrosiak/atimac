...
int main(){
    ...
    /*
	printf("--------------------\n");
    atimac_calculate(mp,zp,ein, mt+1, zt+1,rho,thick,isgas,&results);
	atimac_print(&results);
    printf("--------------------\n");
    atimac_calculate(mp,zp,ein, mt, zt,rho,thick,isgas,&results);
	atimac_print(&results);
	printf("--------------------\n");
	atimac_calculate(mp,zp,ein, mt+2, zt+2,rho,thick,isgas,&results);
	atimac_print(&results);
    printf("--------------------\n");
	atimac_calculate(mp,zp,ein, mt+3, zt+3,rho,thick,isgas,&results);
	atimac_print(&results);
    printf("--------------------\n");
	atimac_calculate(mp,zp,ein, mt+3, zt+3,rho,thick,isgas,&results);
	atimac_print(&results);
